...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Leaderboard.objects.create(user='batman', score=80)
        ...
        Workout.objects.create(name='Web Sling', description='Swing between buildings')
        Workout.objects.create(name='Detective Training', description='Solve mysteries')
        Workout.objects.create(name='Flight', description='Fly around the city')
